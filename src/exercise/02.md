# Compound Components: Make your implementation of your component to be flexible and changeable.

## 📝

Compound Components refers to the children in this course (aka. set of
components)
